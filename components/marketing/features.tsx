    ...
    <section id="features" className="py-32 px-4 bg-gradient-to-b from-gray-100 via-gray-50 to-white">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {features.map((feature, index) => (
            <motion.div 
              ...
              className="border-l-2 border-green-400 pl-8"
            >
        ...
        <motion.div 
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
          className="mt-20 pt-20 border-t border-green-400 border-opacity-30"
        >
          <div className="grid grid-cols-3 gap-8 text-center">
            <motion.div variants={itemVariants}>
              <div className="text-3xl font-light text-gray-900 mb-2">10+</div>
              <div className="text-sm text-gray-500 font-light">Hours saved monthly</div>
            </motion.div>
            <motion.div variants={itemVariants}>
              <div className="text-3xl font-light text-gray-900 mb-2">247</div>
              <div className="text-sm text-gray-500 font-light">Charities ready</div>
            </motion.div>
            <motion.div variants={itemVariants}>
              <div className="text-3xl font-light text-gray-900 mb-2">5min</div>
              <div className="text-sm text-gray-500 font-light">Setup time</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
