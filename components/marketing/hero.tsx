    ...
    <section id="hero" className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 py-32 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-0 w-56 h-40">
          ...
          <div className="absolute bottom-6 left-6 w-10 h-10 bg-ethereal opacity-30"></div>
        ...
        <div className="absolute top-1/2 right-0 w-24 h-48 -translate-y-1/2">
          ...
          <div className="absolute top-24 right-3 w-6 h-6 bg-ethereal opacity-25 rotate-45"></div>
        ...
        <div className="absolute top-1/3 left-0 w-32 h-32">
          ...
          <div className="absolute top-16 left-16 w-8 h-8 bg-ethereal opacity-20 rotate-45"></div>
        </div>
      </div>
        ...
        >
          ...
          <div className="space-y-8">
            <motion.h1 
              ...
              className="text-6xl lg:text-7xl font-light text-foreground leading-tight tracking-tight"
            >
              Annual Return
              <br />
            ...
            <motion.p 
              ...
              className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto font-light"
            >
          ...
          >
            ...
            >
              <Link 
                href="/login" 
                className="inline-block bg-ethereal text-foreground px-12 py-4 rounded-full font-medium hover:bg-ethereal/90 transition-colors duration-200 shadow-lg"
              >
                Try CharityPrep
              </Link>
            </motion.div>
            ...
            <motion.div 
              ...
              className="flex items-center justify-center gap-8 text-sm text-muted-foreground/70 font-light"
            >
